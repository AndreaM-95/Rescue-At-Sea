...
public class PlayerMovement : MonoBehaviour
{
   ...
   // public Animator animator;
    ...
    void Update()
    {
      ...
      //  transform.Rotate(0, xMove * Time.deltaTime * 250, 0); //Girar


     // animator.SetFloat("VelX", xMove); //Animación del Movimiento al correr/Girar/Saltar
     // animator.SetFloat("VelY", zMove); //Animación del Movimiento al correr/Girar/Saltar
